...
<template>
    <fieldset class="border-1 border-gray-500 px-4 my-4">
        <legend class="text-gray-500 px-2 text-sm" :class="{'form-label-required': props.required}">{{ props.displayName }}</legend>
        <div class="flex flex-col gap-2 mx-1 mt-3 mb-4">
            ...
            <label class="flex gap-3 cursor-pointer align-middle">
                <input class="cursor-pointer" :value="true" :name="id" :required="props.required" v-model="value"
                    type="radio" />
            ...
            <label class="flex gap-3 cursor-pointer mr-1 align-middle">
                <input class="cursor-pointer" :value="false" :name="id" :required="props.required" v-model="value"
                    type="radio" />
                <span class="text-black grow-0">
                    {{ props.optionFalse }}
                </span>
