...
<template>
    <fieldset class="border-1 border-gray-500 px-4 my-4">
        <legend class="text-gray-500 px-2 text-xs" :class="{ 'form-label-required': props.required }">{{ props.displayName }}
        </legend>
        <div class="flex flex-col gap-2 mx-1 mt-3 mb-4">
            ...
            <label v-for="(option, i) in props.options" class="flex ml-2 items-center gap-1 cursor-pointer">
                <input class="border-b-1 border-gray-400 w-4 h-4 min-w-4 cursor-pointer"
